...
<div id="main-wrap">
    ...
    <div class="boxes-full">
        ...
        <div class="contacttitle">
            ...
            <h2 align="center">Vice President Result of 2016 NANS election:</h2>
                    ...
                    <fieldset>
                        <div id="center">
                            <table width="100%" border="1px" >
                                ...
                                $query= "SELECT `name`,`votes`,`school` FROM `vice_president` WHERE votes =(SELECT MAX(votes) FROM `vice_president`)";
                                ...
                                $query = "SELECT `name`,`votes`,`school` FROM `vice_president`";
                                $query_run = mysql_query($query);
                                $numberRow = mysql_num_rows($query_run);
