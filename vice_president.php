...
$query = "SELECT `vp` FROM `voters` WHERE `id`='".$_SESSION['user_id']."'";
...
if(isset($_POST['vice_president'])) {
    ...
    if (!empty($vice_president)) {
        //$query = "SELECT `votes` FROM `vice_president` WHERE `candidate_id`= '".mysql_real_escape_string($vice_president)."'";
        $query = "UPDATE `vice_president` SET `votes`=`votes`+1 WHERE `candidate_id`= '".mysql_real_escape_string($vice_president)."'";

                if ($query_run = mysql_query($query)) {
                    $qry = "UPDATE `voters` SET `vp` = '$vice_president' WHERE `id`='".$_SESSION['user_id']."'";
...
<div id="main-wrap">
    ...
    <div class="boxes-full">
        ...
        <div class="contacttitle">
            ...
            <h2 align="center">2016 National Association Of Nigerian Student Election:<br> Vice President National Affairs Ballot Paper</h2>
        ...
        <div class="boxes-padding fullpadding">
            ...
            <form action="<?php echo  $current_file;?> " method="post" name="ajaxcontactform" >
                ...
                $query = "SELECT `name`,`school`,`candidate_id`,`department`,`level`,`cgpa`,`image` FROM `vice_president`";
                ...
                while ($i<$count) {
                    ...
                    echo ' <fieldset>
                        <div class="col-md-3">';
                    echo "<input type='radio' name='vice_president' value=".$candidate_id.">";
                    echo '</div>
