...
<div id="main-wrap">
    ...
    <div class="boxes-full">
        ...
        <div class="contacttitle">
            ...
            <h2 align="center">Treasure Result of 2016 NANS election:</h2>
                    ...
                    <fieldset>
                        <div id="center">
                            <table width="100%" border="1px" >
                                ...
                                $query= "SELECT `name`,`votes`,`school` FROM `treasure` WHERE votes =(SELECT MAX(votes) FROM `treasure`)";
                                ...
                                $query = "SELECT `name`,`votes`,`school` FROM `treasure`";
                                $query_run = mysql_query($query);
                                $numberRow = mysql_num_rows($query_run);
