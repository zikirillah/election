...
<div id="main-wrap">
    ...
    <div class="boxes-full">
        ...
        <div class="contacttitle">
            ...
            <h2 align="center">Presidential Result of 2016 NANS election:</h2>
            ...
            <form action="" method="post" name="ajaxcontactform" >
                ...
                <div class="splitnone">
                    <fieldset>
                        ...
                        $query= "SELECT `name`,`votes`,`school` FROM `president` WHERE votes =(SELECT MAX(votes) FROM `president`)";
                    ...
                    $query = "SELECT `name`,`votes`,`school` FROM `president`";
                    $query_run = mysql_query($query);
                    $numberRow = mysql_num_rows($query_run);
